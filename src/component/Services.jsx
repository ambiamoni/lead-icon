...
const Services = () => {
    return (
        <div className='bg-gray-100 p-20 text-center'>
            <h2 className='text-center text-3xl text-gray-800 font-medium py-20'>Lead Icon Program এ যা যা থাকছে</h2>
            ...
            <div className='bg-gray-600 mt-10 hover:bg-gray-800 rounded-md inline-block'>
                <button className='px-5 py-2 text-white text-sm font-bold flex'>
                    Earnning Start
